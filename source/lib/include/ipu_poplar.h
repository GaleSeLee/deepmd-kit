...
namespace utils
{
    ...
    inline std::string getExeFileName(const Options &options)
    {
        return options.exeName + ".poplar";
    }

    inline poplar::Executable compileOrLoadExe(
        poplar::Graph &graph,
    ...
    inline poplar::Device getDeviceFromOptions(const Options &options)
    {
